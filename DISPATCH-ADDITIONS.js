...
const DISPATCH_CHANNELS = [
  'settings:getAll', 'settings:patch',
  'dashboard:stats', 'dashboard:overview',
  'reports:salesInRange', 'reports:salesCsv',
  'reports:purchasesInRange', 'reports:purchasesCsv',
  'products:list', 'products:search', 'products:add', 'products:update', 'products:remove', 'products:exportCsv',
  'categories:list', 'categories:add', 'categories:update', 'categories:remove',
  'sales:create', 'sales:list', 'sales:items', 'sales:remove',
  'suppliers:list', 'suppliers:add', 'suppliers:update', 'suppliers:remove',
  'purchases:create', 'purchases:list', 'purchases:items', 'purchases:detail', 'purchases:remove',
  'credit:list', 'credit:add', 'credit:remove'
];
